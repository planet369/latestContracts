...
(define-public (collect-funds (fund_id (string-utf8 256)) (action_id (string-utf8 256))) 
  ...
  (let (
     ...
     (fund_info (unwrap! (map-get? fund-allocation { action_id: action_id,  fund_id: fund_id}) (err 21) ))
      ...
      (usd_tuple (unwrap! (map-get? total_fund_usd { action_id: action_id}) (err 21) ))
      (total_usd (get usd usd_tuple))
      (stx_tuple (unwrap! (map-get? total_fund_stx { action_id: action_id}) (err 21) ))
      ...
      (begin 
        ...
        (unwrap!(stx-transfer? STX actionAddress tx-sender) (err u32))
