...
(define-public (add-fund-reciepts (fund_name (string-utf8 256)) (action_id (string-utf8 256)) (reciept_id (string-utf8 256)) (fund_id (string-utf8 256)) (fund_reciever_principal principal) (ardUSD uint) (ardSTX uint)) 
;; let the action-id owner add fund allocation to his action 
 
 (let (
     
     (fund_info (map-get? fund-allocation { action_id: action_id,  fund_id: fund_id}))
    ...
    (begin 
        ...
        (asserts! (is-eq tx-sender reciever ) (err u21))
